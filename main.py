...
def register():
    ...
    if form.validate_on_submit():
        # Валидируются пароли и почта,
        # проверяется, есть ли добавляемый юзер в системе
...
def create_note():
    ...
    if request.method == "GET":
        # Установить значение цвета заметки на дефолтное из настроек юзера
    ...
    if form.validate_on_submit() and request.method == "POST":
        ...
        # Заметка создаётся, юзер возвращается на главную страницу с заметками
